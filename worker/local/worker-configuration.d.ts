/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/local/wrangler.jsonc --env-interface=LocalEnv worker/local/worker-configuration.d.ts` (hash: 708bccc9a8fab5e6c9a100ecff4d5a6b)
// Runtime types generated with workerd@1.20260831.1 2026-09-15 nodejs_compat
interface __BaseEnv_LocalEnv {
	DB: D1Database;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../multiuser/worker");
	}
	interface Env extends __BaseEnv_LocalEnv {}
}
interface LocalEnv extends __BaseEnv_LocalEnv {}
